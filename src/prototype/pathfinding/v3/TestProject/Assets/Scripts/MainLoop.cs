...
public class MainLoop : MonoBehaviour, IHandleMouseEvents
{
    ...
    void Start()
    {
        ...
        //var buttonStrip = new ButtonStrip();
        //buttonStrip.x = 200;
        //buttonStrip.y = 200;
        //buttonStrip.Orientation = ButtonStripOrientation.Horizontal;
        //buttonStrip.Spacing = 5.0f;
        //buttonStrip.AddButton(new FButton("move"));
        //buttonStrip.AddButton(new FButton("attack"));
        //buttonStrip.AddButton(new FButton("cancel"));
        //tileStage.AddChild(buttonStrip);
    } 
