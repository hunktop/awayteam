...
/* 
 * This is some code by Eric Lippert for doing line of sight calculations.
 * http://blogs.msdn.com/b/ericlippert/archive/2011/12/12/shadowcasting-in-c-part-one.aspx
 * Might come in handy somewhere.  Very nice implementation, I don't quite understand it 
 * yet and it uses some somewhat advanced C# stuff.  I only changed it a little bit to 
 * allow for a different definition of distance (was using Euclidean by default, but I want 
 * to be able to experiment with Manhattan).
 */
...
public static class ShadowCaster
{
    ...
    public static void ComputeFieldOfViewWithShadowCasting(
        ...
        Func<int, int, int, bool> isInRadius)
    {
    ...
    private static void ComputeFieldOfViewInOctantZero(
        ...
        int radius, Func<int, int, int, bool> isInRadius)
    {
